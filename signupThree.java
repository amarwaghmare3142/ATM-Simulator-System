...
public class signupThree extends JFrame implements ActionListener{
    ...
    signupThree(String formno){
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-3142");
        ...
        carddetail.setBounds(100, 330, 200, 15);
        add(carddetail);
        ...
        pindetail.setBounds(100, 400, 200, 15);
        add(pindetail);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == submit){
            ...
            String cardnumber = "" + Math.abs((random.nextLong() %90000000L) + 6669936000000000L);
